    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plot_year', models.IntegerField(choices=config.enumerations.YearEnum.choices, default=2025)),
                ('germplasm_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data_storage.germplasm')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('establishment_year', models.IntegerField(choices=config.enumerations.YearEnum.choices, default=2025)),
                ('multi_year', models.BooleanField(default=False)),
                ('experimental_unit_level', models.CharField(choices=[('main plot', 'Main Plot'), ('split plot', 'Split Plot'), ('split split plot', 'Split Split Plot'), ('split split split plot', 'Split Split Split Plot')])),
                ...
                ('project_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project_trials', to='resources.project')),
            ],
        ),
        migrations.AddField(
            model_name='plot',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(choices=config.enumerations.YearEnum.choices, default=2025)),
                ('trial_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data_storage.trial')),
            ],
        ),
