    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('funding', models.CharField(help_text='Fill in the funding agency, and grant number if applicable.', max_length=255)),
        ...
        migrations.AddConstraint(
            model_name='project',
            constraint=models.UniqueConstraint(fields=('name', 'slug'), name='project_unique_constraint'),
        ),
        migrations.AddField(
            model_name='address',
            name='state_id',
